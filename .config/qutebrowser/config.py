# Background colors
bg0 = "#24283b"  # Dark background
bg1 = "#1f2335"  # Darker background
bg2 = "#292e42"  # Lighter background
bg3 = "#3b4261"  # Selection background

# Foreground colors
fg0 = "#c0caf5"  # Normal text
fg1 = "#a9b1d6"  # Dimmed text
fg2 = "#9aa5ce"  # More dimmed
...
c.colors.tabs.pinned.selected.odd.fg = fg0
